...
const Toast = () => {
    return (
        <div className='absolute bg-lime-500 top-[80px] right-[10px] z-[999999999]  py-2 px-10 rounded-lg shadow-lg'>
    ...
    useEffect(() => {
        ...
        if (users) {
            setFormData({
                ...
                company_name: users.additional_info?.company_name,
                description: users.additional_info?.description,
                location: users.additional_info?.location,
            });
        }
    }, [users]);
