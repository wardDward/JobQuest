...
import { fetchJobs } from "../../redux/actions/jobAction"; // Update the path accordingly
...
export default function SearchSection() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    dispatch(fetchJobs(formValues));
  };

  return (
    <div className="py-7 px-5 lg:px-7 bg-darkerBlue flex flex-col justify-center items-center mt-[60px]">
      <form
      ...
      >
        ...
        <div className="flex flex-col mt-[22px] mx-0 md:mx-3 w-full md:w-[25%]">
          <select
            ...
            onChange={handleChange}
            className="py-[8.5px] px-3 rounded-md outline-none text-gray-500 w-full"
            defaultValue=""
          >
            ...
            <div className="flex flex-wrap w-full items-center mt-3 justify-center md:justify-start relative">
              <div className="flex flex-col w-full sm:w-[23%] md:w-[15%] mt-2">
                <select
                  ...
                  onChange={handleChange}
                  className="py-[10px] px-3 text-white bg-darkerBlue border-[2px] border-white rounded-full w-full outline-none"
                  defaultValue=""
                >
                  <option disabled value="">
                    All work types
